...
# Database Subnet - Database NSG
resource "azurerm_subnet_network_security_group_association" "tf-ecomm-db-sn-nsg" {
  subnet_id                 = azurerm_subnet.tf-ecomm-db-sn.id
...
# Databse Network Interface
resource "azurerm_network_interface" "tf-ecomm-db-nic" {
  name                = "db-nic"
  location            = azurerm_resource_group.tf-ecomm.location
  resource_group_name = azurerm_resource_group.tf-ecomm.name
